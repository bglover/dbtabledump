...
DbTableDump requires PHP 8.1 or higher. A database backend is also required - Supported database drivers are [here](#user-content-supported-database-drivers).
